            ...
            <Popover open={isOpen} onOpenChange={setIsOpen}>
                <PopoverTrigger asChild>
                    <Button
                        ...
                        variant={"outline"}
                        className={cn(
                            "h-8 justify-start text-left font-normal bg-white border-slate-200 text-slate-500 rounded-lg text-[13px] px-3",
                ...
                <PopoverContent className="w-auto p-0 rounded-2xl border-slate-200 shadow-xl" align="end" sideOffset={8}>
                    <div className="flex flex-col">
                        ...
                        <div className="border-t border-slate-100 p-3 bg-slate-50/50 rounded-b-2xl">
                            <p className="text-[10px] font-bold text-slate-500 mb-2 tracking-wider">Quick Select</p>
                            <div className="flex flex-wrap items-center gap-2">
                                <Button variant="outline" size="sm" className="h-7 text-[10px] font-semibold bg-white border-slate-200 text-slate-600 rounded-md shadow-sm" onClick={setYesterday}>Yesterday</Button>
                                <Button variant="outline" size="sm" className="h-7 text-[10px] font-semibold bg-white border-slate-200 text-slate-600 rounded-md shadow-sm" onClick={setToday}>Today</Button>
                                <Button variant="outline" size="sm" className="h-7 text-[10px] font-semibold bg-white border-slate-200 text-slate-600 rounded-md shadow-sm" onClick={() => setQuickSelect(7)}>Last 7 Days</Button>
                                <Button variant="outline" size="sm" className="h-7 text-[10px] font-semibold bg-white border-slate-200 text-slate-600 rounded-md shadow-sm" onClick={() => setQuickSelect(30)}>Last 30 Days</Button>
                            </div>
                        </div>
                    </div>
                </PopoverContent>
