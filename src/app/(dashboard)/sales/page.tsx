...
const initialInvoices = [
    {
        ...
        notes: "Payment due within 30 days. Bank: Oriental Bank of Commerce, Acc: 10012151004216, IFSC: ORBC100121"
    },
    {
        id: "INV-18270",
        date: "03 Jan, 2026",
        dueDate: "10 Jan, 2026",
        customer: "Hyatt-Kutch",
        jobRef: "JOB-83077",
        amount: "₹10,082.63",
        tax: "₹1,538.03",
        status: "Unpaid",
        items: [{ id: 1, desc: "Misc Printing", qty: 1, rate: 8544.60, amount: 8544.60 }],
        notes: ""
    },
    {
        id: "INV-02176",
        ...
        tax: "₹463.91",
        status: "Paid",
        items: [{ id: 1, desc: "Business Cards", qty: 500, rate: 7.34, amount: 3670 }],
        notes: ""
    }
]
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <div className="lg:col-span-2 space-y-6">
                            ...
                            <CardContent className="p-4 sm:p-6">
                                <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input type="date" defaultValue="2026-02-11" className="border-blue-100" />
                                    </div>
                                    <div className="space-y-2">
                                        <Label className="text-xs font-bold uppercase tracking-wider opacity-60">Due Date</Label>
                                        <Input type="date" defaultValue="2026-03-13" className="border-blue-100" />
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="border-none shadow-xl shadow-slate-200/50 overflow-hidden">
                            <CardHeader className="bg-muted/30 border-b flex flex-row items-center justify-between py-3">
                                <CardTitle className="text-sm font-black uppercase tracking-widest text-slate-800 flex items-center gap-2">
                                    <Coins className="h-4 w-4 text-emerald-600" /> Line Items
                                </CardTitle>
                                <Button size="sm" variant="outline" className="gap-2 border-blue-200 text-blue-600 hover:bg-blue-50 font-bold" onClick={addFormItem}>
                    ...
                    <div className="space-y-6">
                        <Card className="border-none shadow-xl shadow-slate-200/50 bg-gradient-to-br from-slate-900 to-slate-800 text-white">
                            <CardHeader>
                                <CardTitle className="text-sm font-black uppercase tracking-widest opacity-60">Bill Summary</CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="flex justify-between items-center text-sm">
                                    <span className="opacity-60">Subtotal</span>
                                    <span className="font-bold">₹42,329.00</span>
                                </div>
                                <div className="space-y-2">
                        ...
                        <Card className="border-none shadow-xl shadow-slate-200/50">
                            <CardHeader>
                                <CardTitle className="text-sm font-black uppercase tracking-widest text-slate-800">Payment Instructions</CardTitle>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="space-y-2">
                                    <Label className="text-xs font-bold opacity-60 tracking-wider">Public Notes</Label>
                                    <Textarea placeholder="Enter bank details or T&C..." className="min-h-[120px] bg-muted/30 border-none text-xs leading-relaxed" defaultValue="Payment due within 30 days. Bank: Oriental Bank of Commerce, Acc: 10012151004216, IFSC: ORBC100121" />
                                </div>
                                <Button variant="outline" className="w-full gap-2 border-slate-200 font-bold h-10 italic">
                                    <Calculator className="h-4 w-4" /> Save as Template
                                </Button>
                            </CardContent>
                        </Card>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8">
                            ...
                            <div className="space-y-4">
                                <div className="flex justify-between items-center px-4 py-2 bg-slate-50 rounded-lg">
                                    ...
                                    <span className="font-black">₹42,329.00</span>
                                </div>
